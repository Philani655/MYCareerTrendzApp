$(document).ready(function () {
    $('#nameForm').submit(function (event) {
        ...
        if (isValid) {
            ...
            $.ajax({
                url: '../php/parent_update_profile_file.php', // PHP script to handle form submission
                type: 'POST',
                data: formData,
                ...
                success: function (response) {
                    alert('Parent profile is updated successfully!');
                ...
                error: function () {
                    alert('Something went wrong with parent update');
                }
            });
        }
