    ...
    if (isset($_FILES['image'])) {
        ...
        if (in_array($fileExtension, $allowedTypes)) {
            if (move_uploaded_file($imageTmpName, $uploadFile)) {
                ...
                $sqlLearner = "UPDATE parent SET name=?, surname=?, email=?, password=?, contactno=?, location=?, date_time=? WHERE idno=?";
                ...
                if ($stmtLearner) {
                    ...
                    if ($stmtLearner->execute()) {
                        ...
                        echo "<script>window.location.href='../php/parent_profile.php';</script>";
                    } else {
