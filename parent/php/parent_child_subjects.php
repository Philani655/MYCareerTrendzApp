    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="col-md-5 col-sm-6 col-xs-12">                    
                <a href="../php/parent_learner_attendance_file.php?id=<?php echo $row['id']?>&subjectname=<?php echo $row['subjectname']?>&subjectcode=<?php echo $row['subjectcode']?>&grade_name=<?php echo $row['grade_name']?>&grade_id=<?php echo $row['grade_id']?>" >
                    <div class="info-box">
