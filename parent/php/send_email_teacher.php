            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Teacher Emails</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><img src="../icons/message.png" width="25"> Teacher Emails</h3>
                                                ...
                                                <div class="email-list list-group">
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_assoc()) {
                                                            ?>
                                                            <a href="../php/parent_sent_email_store_file.php?idno=<?php echo $row['idno']; ?>"class="email-item list-group-item">
