                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            if ($row['status'] === 0) {
                                                                ...
                                                                <form action="../php/parent_notification_file.php" method="Post">
                                                                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                                                    <button class="btn" style="border-radius: 1.125rem 1.125rem 0 1.125rem; border: 1px solid black; width: 100%; text-align: start; background: #CC0000; color: #fff;"><img src="../icons/conversation.png" width="25"> <?php echo $row['message']; ?></button>
                                                                </form>
                                                                <?php
                                                            } else {
                                                                ?> 
                                                        ...
                                                        ?>   
                                                        <div class="container-fluid">
                                                            <p>There are no notification to display.</p>
                                                        </div><?php
                                                }
                                                $stmt->close();
                                                    ?>
