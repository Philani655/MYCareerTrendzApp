                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><img src="../icons/mail-inbox-app.png" alt="mail" width="25"> Inbox</h3>
                                    ...
                                    <div class="box-body">
                                        ...
                                        $sql = "SELECT t.idno AS idno ,
                                                    ...
                                                    FROM parent p, email e ,teacher t , subjects su
                                        ...
                                        $stmt->bind_param("ssssi", $idNumber, $teacher_id, $subjectcode, $subjectname, $grade_id);
                                                                                ...
                                                                                <div class="modal-dialog modal-lg" role="document">
                                                                                    <div class="modal-content">
                                                                                        <form action="../php/teacher_sent_email_file.php" method="post" enctype="multipart/form-data" style="margin-top: 50px;">
                                                                                            ...
                                                                                            <button type="submit" class="btn btn-success" style="margin-left: 10px;">Send Reply</button>
                                                                                        </form>
