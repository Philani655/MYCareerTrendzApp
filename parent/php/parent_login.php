                ...
                <div class="row align-items-center justify-content-center h-100 g-0 px-4 px-sm-0">
                    <div class="col col-sm-6 col-lg-7 col-xl-6">
                        ...
                        <a href="#" class="d-flex justify-content-center mb-3">
                            <img src="../icons/family-1.png" alt="" width="60">
                        </a>

                        <div class="text-center mb-4">
                            <h3 class="fw-bold">PARENT</h3>
                            <p class="fw-bold fs-4">Sign-in</p>
                        </div>

                        <form id="loginForm" action="../php/parent_login_file.php" method="post" onsubmit="return isValidateLogin()">
                        ...
                        <div class="input-group mb-3 d-flex justify-content-between">
                            ...
                            <div>
                                <small><a href="../php/parent_forgot_password.php">Forgot Password</a></small>
                            </div>
                        </div>

                        <div class="text-center">
                            <small>Don't have an account? <a href="../php/parent_register.php" class="fw-bold">Sign-Up</a></small>
                        </div>
