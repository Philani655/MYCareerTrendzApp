...
<body>
    ...
    if (empty($idNumber)) {
        ...
        $stmt = $conn->prepare("SELECT * FROM parent WHERE idno = ?");
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="d-flex justify-content-center gap-3">
                    <button class="btn btn-danger close-btn" onclick="window.location.href = '../php/parent_dashboard.php'">Close</button>
    ...
    <!-- Optional JavaScript -->
    <script src="../javascript/parent_profile.js"></script>
