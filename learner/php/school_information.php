                                ...
                                <div class="box-body">
                                    ...
                                    <form id="schoolInformation" class="form-horizontal" action="../php/school_information_file.php" method="post"    onsubmit="return isSchoolInformation()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php include './schoolsModal.php'; ?>
                                        </div>

                                        <div class="form-group">
                                            <label for="address" class="col-sm-3 control-label">School Address:</label>
                                            <div class="col-sm-9">
                                                <input type="text" id="address" name="address" style="padding-right: 100px;">
                                                <label style="color: red;">*</label>
                                        ...
                                        <div class="form-group">
                                            <label for="officeNo" class="col-sm-3 control-label">Telephone:</label>
                                            <div class="col-sm-9">
                                                <input type="text" id="officeNo" name="officeNo" style="padding-right: 100px;">
                                                <label style="color: red;">*</label>
                                        ...
                                        <div class="form-group">
                                            <label for="grade" class="col-sm-3 control-label">Subjects:</label>
                                            <div class="col-sm-3">
