<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title" style="color: steelblue;">Learner Information</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">

                                    <form id="learnerAdmission"class="form-horizontal" action="../php/learner_admission_file.php" method="post" onsubmit="return isLearnerAdmission()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                            include '../php/learner_postal_code_modal.php';
                                            ?>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="email" name="verifyEmail" id="verifyEmail" style="padding-right: 100px;">
                                                <label style="color: red;">&ast;</label>
        ...
        <script src="../javascript/learner_postal_code.js"></script>
        <!-- Load jQuery first -->
        <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script> 
        <script src="../javascript/learner_admission.js"></script>
    </body>
</html>
