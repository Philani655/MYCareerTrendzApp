                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title"> <?php echo $_GET['assignment_name']?></h3>
                                <div class="box-tools pull-right">
                                    <a href="../php/learner_assignments.php" style="text-decoration: none;"><i class="fa-solid fa-arrow-left"></i> <b>Back</b></a>
                                </div>
                            </div><!-- /.box-header -->
                            <div class="box-body">
                                <div class="row">
