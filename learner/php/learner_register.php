        ...
        <div class="container">
            <div class="form-container">
                <div class="col-md-8 col-lg-6">
                    <form class="mx-auto" action="../php/learner_register_file.php" method="post" onsubmit="return isValidateRegister()">
                        <!-- Logo -->
                        <a href="#" class="d-flex justify-content-center">
                            <img src="../icons/learners_login_page.png" alt="MYCareerTrendz Logo" width="60">
                        </a>

                        <!-- Heading -->
                        <h4 class="text-center">LEARNER</h4>
