                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">True or False Online Test</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="chart">
                                                ...
                                                // Fetch all questions
                                                $sql = "
                                                            SELECT oz.id, oz.teacher_id, oz.subject_id, oz.grade_id, oz.question, oz.correct_answer, oz.date_time 
                                                            FROM online_quiz oz
                                                            JOIN subjects s ON s.id = oz.subject_id 
                                                            WHERE s.subjectname = ?  
                                                            AND s.subjectcode = ?  
                                                            AND oz.grade_id = ?
                                                            AND (oz.correct_answer = 'True' OR oz.correct_answer = 'False')
                                                        ";
                                                ...
                                                <form action="../php/learner_online_quiz_score_file.php" method="POST">
                                                    <?php foreach ($questions as $index => $question): ?>
                                                        <div class="mb-4">
                                                            <label class="form-label"><?php echo ($index + 1) . ". " . htmlspecialchars($question['question']); ?></label>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="answer_<?php echo $question['id']; ?>" value="True" required>
                                                                <label class="form-check-label">True</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="answer_<?php echo $question['id']; ?>" value="False" required>
