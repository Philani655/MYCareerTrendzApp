                ...
                <div class="row align-items-center justify-content-center h-100 g-0 px-4 px-sm-0">
                    <div class="col col-sm-6 col-lg-7 col-xl-6">
                        ...
                        <a href="#" class="d-flex justify-content-center mb-3">
                            <img src="../icons/learners_login_page.png" alt="" width="60">
                        </a>

                        <div class="text-center mb-4">
                            <h3 class="fw-bold">LEARNER</h3>
                            <p class="fw-bold fs-4">Sign-in</p>
                        </div>

                        <form id="loginForm" action="../php/learner_login_file.php" method="post" onsubmit="return isValidateLogin()" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3 d-flex justify-content-between">
                            ...
                            <div>
                                <small><a href="../php/learner_forgot.php">Forgot Password</a></small>
                            </div>
                        </div>

                        <div class="text-center">
                            <small>Don't have an account? <a href="learner_register.php" class="fw-bold">Sign-Up</a></small>
                        </div>
