...
<body>
    ...
    if (empty($idNumber)) {
        ...
        $stmt = $conn->prepare("SELECT * FROM learner WHERE idno = ?");
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="d-flex justify-content-center gap-3">
                    <button class="btn btn-danger close-btn" onclick="window.location.href = '../php/learner_dashboard.php'">Close</button>
    ...
    <!-- Optional JavaScript -->
    <script src="../javascript/learner_profile.js"></script>
