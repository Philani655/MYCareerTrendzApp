                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            if ($row['status'] === 0) {
                                                                ...
                                                                <form action="../php/school_announcement_file.php" method="Post">
                                                                    ...
                                                                    <button class="btn" style="border-radius: 1.125rem 1.125rem 0 1.125rem; border: 1px solid black; width: 100%; text-align: start; background:  #e8192f ; color: #fff;">
                                                                        <img src="../icons/conversation.png" width="25"> <?php echo $row['message']; ?>
                                                                    </button>
                                                                </form>
                                                                <?php
                                                            } else {
