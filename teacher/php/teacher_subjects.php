...
<div class="row">
    ...
    $sql = "SELECT g.id as grade_id ,s.id as id, s.subjectname as subjectname, s.subjectcode as subjectcode, s.grade_id as grade_id ,g.grade_name as grade_name 
            FROM subjects s 
            JOIN teacher t ON t.grade_id = s.grade_id   
            JOIN grade g ON t.grade_id = g.id 
            WHERE s.learner_id = ? 
            GROUP BY g.id , s.id , s.subjectname ,s.subjectcode, s.grade_id ,g.grade_name ";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="col-md-5 col-sm-6 col-xs-12">
                <a href="../php/my_learner_file.php?id=<?php echo $row['id']?>&subjectname=<?php echo $row['subjectname']?>&subjectcode=<?php echo $row['subjectcode']?>&grade_name=<?php echo $row['grade_name']?>&grade_id=<?php echo $row['grade_id']?>" >
                    <div class="info-box">
