                                        ...
                                        <div class="col-md-5">
                                            <div class="chart">
                                                ...
                                                <div class="container-fluid">
                                                    ...
                                                    $result = mysqli_query($conn, "SELECT * FROM `online_class_test_details`") or die('Error');
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Clear Multiple Choose Test</h4>
                                        </div>
                                        <div class="modal-body">
                                            Are you sure that you want to clear <b>Multiple choose Test</b>
                                        </div>
                                        <div class="modal-footer">
                                            <form method="POST" action="../php/clear_multiple_choose_test_file.php">
