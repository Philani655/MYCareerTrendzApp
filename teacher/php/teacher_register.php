        ...
        <div class="container">
            <div class="form-container">
                <div class="col-md-8 col-lg-6">
                    <form class="mx-auto" action="../php/teacher_register_file.php" method="post" onsubmit="return isValidateRegister()">
                        <!-- Logo -->
                        <a href="#" class="d-flex justify-content-center">
                            <img src="../icons/teacher-login.png" alt="MYCareerTrendz Logo" width="60">
                        </a>
