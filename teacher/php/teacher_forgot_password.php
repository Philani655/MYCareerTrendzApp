...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../css/learner_password_style.css">
    </head>
    <body>
                ...
                <div class="row align-items-center justify-content-center h-100 g-0 px-4 px-sm-0">
                    <div class="col col-sm-6 col-lg-7 col-xl-6">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <p class="mt-3" style="text-align: start;"><small>Reset your password by submitting your email address linked to your account.
                                    We will send you an email with a verification OTP code to choose a new password.</small></p>
                        </div>
                        <form id="forgotPasswordForm" action="../php/teacher_forgot_password_file.php" method="post" onsubmit="return isForgotPassword();" >
