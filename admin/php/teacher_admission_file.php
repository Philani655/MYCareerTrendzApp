...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkSQL = "SELECT idno FROM teacher_admission WHERE idno = ?";
    ...
    if ($checkStmt->num_rows > 0) {
        ...
        if ($insertStmt->execute()) {
            echo "<script>window.location.href = '../php/teacher_school_information.php';</script>";
        } else {
