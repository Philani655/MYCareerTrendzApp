...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($subjects) || empty($grade_id) || empty($idno)) {
        header('location: ../php/teacher_subjects_page.php');
        exit();
    }
    ...
    $subjectMap = [
        ...
        'Drama' => 'DRA', 'Economics' => 'ECO', 'Electrical Technology' => 'ELE',
    ...
    echo "<script>alert('Subjects added successfully!'); window.location.href='../php/teacher_subjects_page.php';</script>";
    exit();
} else {
    echo "<script>alert('Invalid request!'); window.location.href='../php/teacher_subjects_page.php';</script>";
    exit();
}
?>
