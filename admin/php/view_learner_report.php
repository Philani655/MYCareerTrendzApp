                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools pull-right">
                                        <a href="learner_result_page.php" style="color: steelblue; text-decoration: none;"><strong><i class="fa-solid fa-arrow-left"></i> Back</strong></a>
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo ($row['final_mark'] !== null) ? $row['final_mark'] : 'No mark'; ?></td>
                                                                <td><?php echo ($row['final_mark'] >=50 ) ? 'Pass': 'Fail'; ?></td>
                                                            </tr>
                                                            <?php
                                                        }
                                                    }
