                                            ...
                                            <table id="myTable" class="table table-striped table-bordered" style="max-width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sql = "SELECT l.id as id , l.idno AS idno, l.name AS name, l.surname AS surname, 
                                                             ...
                                                             FROM learner l, grade g, school s 
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="#add<?php echo $row['id']; ?>" class="btn btn-primary btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-plus"></span> Add</a>
                                                            ...
                                                            <?php
                                                            include '../php/learner_subject_add_modal.php';
                                                            include '../php/learner_subject_delete_modal.php';
                                                        }
                                                    }
                                                    ?>
                                                </tbody>
