                                ...
                                <div class="box-body">
                                    ...
                                    <form id="parentGaurdian" action="../php/parent_guardian_file.php" method="post" class="form-horizontal" onsubmit="return isParentGuardian()">
                                        ...
                                        <div class="form-group">
                                            <label for="resides" class="col-sm-5 control-label">Is the learner resides with the parent/s or guardians?:</label>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            <label for="working" class="col-sm-5 control-label">Is the parent/ guardian working?:</label>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            <label for="idNumber" class="col-sm-5 control-label">Birth Certificate/ ID Number:</label>
                                            <div class="col-sm-3">
                                                <input type="text" name="idNumber" id="idNumber" placeholder="13 Digit" style="padding-right:50px;">
                                                <label style="color: red;">&ast;</label>
