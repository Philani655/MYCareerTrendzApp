...
if (empty($id)|| empty($idno)) {
    header('location: ../php/school_learner_page.php');
    exit();
}
?>
<html>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title" style="color: steelblue;">Add School Under Learner</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">

                                    <form id="schoolInformation" class="form-horizontal" action="../php/school_add_learner_file.php" method="post"    onsubmit="return isSchoolInformation()">
