                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <a href="../php/teacher_admission.php" data-toggle="modal" class="btn btn-primary" style="margin-left: 50px;"><span class="glyphicon glyphicon-plus"></span> New</a>
                                            ...
                                            <thead>
                                                ...
                                                <tbody>
                                                    ...
                                                    $sql = "SELECT * FROM teacher_admission";
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="../php/teacher_admission_edit.php?id=<?php echo $row['id'];?>" class="btn btn-success btn-sm" data-toggle="modal"><span class="glyphicon glyphicon-edit"></span> Edit</a>
                                                                ...
                                                                <?php include '../php/teacher_admission_delete_modal.php'; ?>
                                                            </tr>
                                                            <?php
                                                        }
                                                    }
