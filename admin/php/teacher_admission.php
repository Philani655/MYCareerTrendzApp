<html>
    ...
    <body class="hold-transition skin-red sidebar-mini">
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title" style="color: steelblue;">Teacher Information</h3>
                                    <div class="box-tools pull-right">
                                        <a href="teacher_admission_page.php" style="color: steelblue; text-decoration: none;"><strong><i class="fa-solid fa-arrow-left"></i> Back</strong></a>
                                    </div>
                                </div><!-- /.box-header -->
                                <div class="box-body">

                                    <form id="teacherAdmission"class="form-horizontal" action="../php/teacher_admission_file.php" method="post" onsubmit="return isTeacherAdmission()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                            include '../php/teacher_postal_code_modal.php';
                                            ?>
                                        </div>

                                        <!-- Contact Information -->
                                        <h4 style="color: steelblue;">Contact Information</h4>
        ...
        <script src="../javascript/teacher_postal_code.js"></script>
        <?php include '../javascript/script.js'; ?>   
        <script src="../javascript/teacher_admission.js"></script>
