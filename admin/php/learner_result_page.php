                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="../php/view_learner_report.php?idno=<?php echo $row['idno'];?>" class="btn btn-success btn-sm" data-toggle="modal" style="margin-right: 5px;"><span class="glyphicon glyphicon-eye-open"></span> View Report</a>
                                                                </td>
                                                            </tr>
                                                            <?php
