...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($count > 0) {
                ...
                if ($stmt) {
                    ...
                    if ($stmt->execute()) {
                        ...
                        echo "<script>window.location.href = '../php/teacher_school_information.php';</script>"; // Redirect to the next page
                        exit();
                    }
                } else {
    ...
    . "window.location.href = '../php/teacher_school_information.php';"
    . "</script>";
}
?>