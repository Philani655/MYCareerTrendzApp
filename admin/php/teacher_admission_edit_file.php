...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateSQL = "UPDATE `teacher_admission` 
    ...
    if ($stmt) {
        ...
        if ($stmt->execute()) {
            echo "<script>alert('Record updated successfully!'); window.location.href='../php/teacher_admission_page.php';</script>";
            exit();
        } else {
            echo "<script>alert('Something went wrong!');window.location.href='../php/teacher_admission_edit.php');</script>";
            exit();
        }
    }
    ...
    . "window.location.href = '../php/teacher_admission.php';"
    . "</script>";
}
?>
