<html>
    ...
    <body class="hold-transition skin-red sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                if ($id) {
                    ...
                    $sql = "SELECT * FROM teacher_admission WHERE id = ?";
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <form id="teacherAdmission"class="form-horizontal" action="../php/teacher_admission_edit_file.php" method="post" onsubmit="return isTeacherAdmission()">
        ...
        <script src="../javascript/teacher_admission_edit.js"></script>
